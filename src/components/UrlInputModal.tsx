        ...
        scale: 1
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <Input value={url} onChange={e => setUrl(e.target.value)} placeholder="Enter URL to analyze..." className="pr-10 border-purple-200 focus:border-purple-300 bg-white/80" />
            ...
            delay: 0.1
              ...
              <Button type="submit" className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white">
                Analyze URL
              </Button>
            </motion.div>
          </form>
