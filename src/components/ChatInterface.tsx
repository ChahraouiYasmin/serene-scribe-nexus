  ...
  return <div className="flex flex-col h-full bg-gradient-to-b from-purple-50/50 to-purple-100/30">
      <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-fuchsia-50">
        ...
        opacity: 1
            ...
            <UrlPreview url={urlPreview.url} title={urlPreview.title} description={urlPreview.description} />
            <Button variant="ghost" size="icon" onClick={clearUrlPreview} className="text-purple-400 hover:text-purple-600 hover:bg-purple-50">
              <X className="h-4 w-4" />
            </Button>
          </motion.div>}
      </div>
